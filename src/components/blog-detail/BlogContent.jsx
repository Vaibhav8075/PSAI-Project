        ...
        <div className="lg:col-span-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-600 text-sm leading-relaxed">
            ...
            <p>
              ...
              understanding your audience and leveraging data-driven insights.
            </p>
          </div>
        </div>

        <div className="bg-gray-100 rounded-2xl p-8 h-fit">
          <h3 className="text-xl font-semibold mb-4">Interesting ?</h3>

          <p className="text-gray-600 mb-6 text-sm">
            Upload your Blog Here to Stay connected with more people they may
