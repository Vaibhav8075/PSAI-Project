  ...
  return (
    <>
      <ServiceBlock
        ...
        image={img2}
        text={["PJIPL is one of Central India’s fastest emerging names in Manpower consultancy which provides a wide range of recruitment solutions for diverse requirements." ,
